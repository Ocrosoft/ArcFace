...
{
    /// <summary>
    ///     modifyRegister 的摘要说明
    /// </summary>
    public class modifyRegister : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            var sql = "update userInRegister set #60J96o where id = ?id;";
            var rep = "";
