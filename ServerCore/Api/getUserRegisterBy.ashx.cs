...
{
    /// <summary>
    ///     getUserRegisterBy 的摘要说明
    /// </summary>
    public class getUserRegisterBy : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            var sql =
                "select id,name,privilege,inTime,validDays,allowRegister,phone,faceImage from user where registerBy = ?uid;";
